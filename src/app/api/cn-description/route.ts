// /api/cn-description —— 中文简介（S2 依据编译产物模块 450 重建）。
// 依次尝试 cngal → ymgal（搜索选最佳 ≥0.3 → 详情）→ bangumi，
...
/** 模块 450 的 x：按名称列表依次尝试三源，返回首个中文简介 */
